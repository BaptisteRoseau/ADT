...
ADT_DIRS = $(QUE_DIR) $(STA_DIR) $(SET_DIR) $(BTR_DIR) $(DEQ_DIR)

CC			= gcc
CFLAGS		= -Wall -Wextra -std=c99 -g -O0 -fPIC
CPPFLAGS	= -I ${TST_DIR}

TESTS_EXEC 	= test_queue test_set test_stack test_bst test_dequeue
...
build: prebuild
	...
	@for dir in $(ADT_DIRS); do \
		${CC} $(CFLAGS) $(dir)/*.c ./$(COM_DIR)/utils.c -o $(dir:%.c=%.o); \ #FIXME
	done
...
test_queue:	./$(TST_DIR)/test_queue.o ./$(TST_DIR)/common_tests_utils.o ./$(COM_DIR)/utils.o ./$(QUE_DIR)/queue.o
	${CC} $(CFLAGS) $^ -o $@

test_set: ./$(TST_DIR)/test_set.o ./$(TST_DIR)/common_tests_utils.o ./$(COM_DIR)/utils.o ./$(SET_DIR)/set.o
	${CC} $(CFLAGS) $^ -o $@

test_stack:	./$(TST_DIR)/test_stack.o ./$(TST_DIR)/common_tests_utils.o ./$(COM_DIR)/utils.o ./$(STA_DIR)/stack.o
	${CC} $(CFLAGS) $^ -o $@

test_bst: ./$(TST_DIR)/test_bst.o ./$(TST_DIR)/common_tests_utils.o ./$(COM_DIR)/utils.o ./$(BTR_DIR)/bst.o
	${CC} $(CFLAGS) $^ -o $@

test_dequeue: ./$(TST_DIR)/test_dequeue.o ./$(TST_DIR)/common_tests_utils.o ./$(COM_DIR)/utils.o ./$(DEQ_DIR)/dequeue.o
	${CC} $(CFLAGS) $^ -o $@
